...
def main(args):
    ...
    # )
    Settings.llm = OpenAI(api_base="http://127.0.0.1:19900/v1", model=args.model_name, request_timeout=200, api_key="xd")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--result_path',type=str,default='../output/pquad/pquad_train_distractor_v1_full',help='Path to the result file')
