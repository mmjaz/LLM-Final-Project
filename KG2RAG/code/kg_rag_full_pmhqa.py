...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path',type=str,default='../data/persianmhqa/all_persian_mhqa.json',help='Path to the data file')
    parser.add_argument('--result_path',type=str,default='../output/pmhqa/pmhqa_train_distractor_v1_full_gemini',help='Path to the result file')
    parser.add_argument('--kg_dir',type=str,default='../data/persianmhqa/kgs/extract_subkgs')
    parser.add_argument('--persist_dir',type=str,default='../data/qwen/pmhqa',help='Directory to store the index')
    ...
    parser.add_argument('--top_k',type=int,default=2,help='Top k similar documents')
